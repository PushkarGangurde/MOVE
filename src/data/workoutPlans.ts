...
const beginnerPlan: DayWorkout[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'fri-m1', name: 'Jumping Jacks', reps: '3 × 30 reps', section: 'main' },
      { id: 'fri-m2', name: 'Bodyweight Squats', reps: '3 × 15 reps', section: 'main' },
      { id: 'fri-m3', name: 'Incline Push-Ups', reps: '3 × 10 reps', section: 'main' },
      { id: 'fri-m4', name: 'Standing Knee Raises', reps: '3 × 20 reps (10 each leg)', section: 'main' },
      { id: 'fri-m5', name: 'Plank Hold', reps: '3 × 30 seconds', section: 'main' },
...
const intermediatePlan: DayWorkout[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'fri-m1', name: 'Burpees', reps: '4 × 10 reps', section: 'main' },
      { id: 'fri-m2', name: 'Jump Squats', reps: '4 × 15 reps', section: 'main' },
      { id: 'fri-m3', name: 'Push-Ups', reps: '4 × 15 reps', section: 'main' },
      { id: 'fri-m4', name: 'Plank Jacks', reps: '4 × 20 reps', section: 'main' },
      { id: 'fri-m5', name: 'Mountain Climbers', reps: '4 × 30 reps (15 each leg)', section: 'main' },
      { id: 'fri-d1', name: 'Standing Forward Fold', reps: '1 minute', section: 'cooldown' },
      { id: 'fri-d2', name: 'Hamstring Stretch', reps: '1 minute', section: 'cooldown' },
