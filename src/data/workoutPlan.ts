...
export const workoutPlan: DayWorkout[] = [
  {
    ...
    exercises: [
      ...
      // Main Workout (4 Rounds - 60-90 sec rest after each round)
  ...
  },
  {
    ...
    exercises: [
      ...
      // Main Workout (4 Rounds - 90 sec rest after each round)
  ...
  },
  {
    ...
    exercises: [
      ...
      // Main Workout (4 Rounds - 60 sec rest after each round)
  ...
  },
  {
    ...
    exercises: [
      ...
      // Main Workout (4 Rounds - 40 sec work, 20 sec rest - 90 sec rest after each round)
  ...
  },
  {
    ...
    exercises: [
      ...
      // Main Workout (3-4 Rounds - 60 sec rest after each round)
  ...
  },
  {
    ...
    exercises: [
      // Recovery Routine (25-30 minutes)
